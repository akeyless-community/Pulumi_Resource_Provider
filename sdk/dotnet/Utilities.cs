...
namespace Pulumi.Akeyless
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/akeyless-community/pulumi-akeyless";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Akeyless.version.txt");
    ...
    internal sealed class AkeylessResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public AkeylessResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
