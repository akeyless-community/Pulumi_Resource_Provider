...
def get_tags(name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('akeyless:index/getTags:getTags', __args__, opts=opts, typ=GetTagsResult).value

    return AwaitableGetTagsResult(
        id=pulumi.get(__ret__, 'id'),
        name=pulumi.get(__ret__, 'name'),
        tags=pulumi.get(__ret__, 'tags'))
def get_tags_output(name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('akeyless:index/getTags:getTags', __args__, opts=opts, typ=GetTagsResult)
