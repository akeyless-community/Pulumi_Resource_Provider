...
export function getCertificate(args?: GetCertificateArgs, opts?: pulumi.InvokeOptions): Promise<GetCertificateResult> {
    ...
    return pulumi.runtime.invoke("akeyless:index/getCertificate:getCertificate", {
...
export function getCertificateOutput(args?: GetCertificateOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCertificateResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("akeyless:index/getCertificate:getCertificate", {
        "ignoreCache": args.ignoreCache,
        "name": args.name,
        "version": args.version,
    }, opts);
