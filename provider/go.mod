module github.com/akeyless-community/pulumi-akeyless/provider
...
require (
	github.com/akeylesslabs/terraform-provider-akeyless v1.11.6
	github.com/pulumi/pulumi-terraform-bridge/v3 v3.121.0
)

replace github.com/akeylesslabs/terraform-provider-akeyless => github.com/akeyless-community/terraform-provider-akeyless v1.11.6
...
require (
	...
	github.com/akeylesslabs/akeyless-go v1.0.0 // indirect
