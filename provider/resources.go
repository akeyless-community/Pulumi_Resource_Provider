...
import (
	...
	tfupstream "github.com/akeylesslabs/terraform-provider-akeyless/akeyless"

	"github.com/akeyless-community/pulumi-akeyless/provider/pkg/version"
)
...
const (
	...
	mainPkg = "akeyless"
	// modules:
	mainMod = "index" // the akeyless module
)

//go:embed cmd/pulumi-resource-akeyless/bridge-metadata.json
var metadata []byte
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		//
		//    - In provider/cmd/pulumi-tfgen-akeyless/main.go, replace the
		...
		//
		//    - In provider/cmd/pulumi-resource-akeyless/main.go, replace the
		...
		//
		//      	tfbridge.Main(context.Background(), "akeyless", akeyless.Provider(),
		...
		// convention is to have a function at "github.com/akeylesslabs/terraform-provider-akeyless/provider".New
		...
		//
		P: shimv2.NewProvider(tfupstream.Provider()),
		...
		Golang: &tfbridge.GolangInfo{
			...
			ImportBasePath: path.Join(
				"github.com/akeyless-community/pulumi-akeyless/sdk/",
	...
	prov.MustComputeTokens(tokens.SingleModule("akeyless_", mainMod,
